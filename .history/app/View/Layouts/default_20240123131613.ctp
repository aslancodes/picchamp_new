...
<div class="navbar">
    ...
    <ul class="nav-links">
		...
		<li><?php echo $this->Html->link('delete images', array('controller' => 'Imagevurl', 'action' => 'deleteImages')); ?></li>

		<li><?php echo $this->Html->link('view images', array('controller' => 'Imagevurl', 'action' => 'clientImages')); ?></li>
