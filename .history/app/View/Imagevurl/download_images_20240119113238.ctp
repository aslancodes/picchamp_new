...
<!-- app/View/Imagevurl/download_images.ctp -->
<?php echo $this->Form->create('Uploadimglink', array('url' => array('action' => 'downloadImages'))); ?>
...
<?php echo $this->Form->create('Uploadimglink', array('url' => array('action' => 'downloadAllImages'))); ?>
<?php echo $this->Form->input('sku_codes', array('type' => 'textarea', 'label' => 'Enter SKU Codes (one per line)')); ?>
