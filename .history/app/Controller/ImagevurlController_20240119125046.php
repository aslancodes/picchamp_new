...
class ImagevurlController extends AppController {
    ...
    public function downloadAllImages() {
        $clients = $this->Uploadimglink->getClientList(); // Add this line

        $this->set('clients', $clients);
        if ($this->request->is('post')) {
            $clientId = $this->request->data['Imagevurl']['client_id'];
            $skuCodesInput = $this->request->data['Imagevurl']['sku_codes'];
            ...
            // Add condition to filter by client if provided
            if (!empty($clientId)) {
            ...
            $tempFolder = WWW_ROOT . 'converted_images' . DS;
