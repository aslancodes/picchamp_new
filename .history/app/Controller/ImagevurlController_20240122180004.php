...
public function index(){
    ...
    public function downloadImagesBySku() {
        // Import the CakeZip utility
        App::import('Vendor', 'CakeZip.CakeZip');
        ...
        if ($this->request->is('post')) {
            ...
            if (!empty($images)) {
                    ...
                    for ($i = 1; $i <= 5; $i++) {
                        ...
                        if (isset($image['Uploadimglink'][$imageLinkIndex])) {
                            ...
                            if (!empty($imageLink)) {
                                ...
                                $zip->addFile("{$image['Uploadimglink']['SKU_CODE']}_image{$i}.jpg", $fileContent);
                            }
                        }
                    }
                }
                ...
                $this->Flash->error(__('No images found for the specified criteria.'));
            }
        }
    }
