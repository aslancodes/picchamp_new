                    ...
                    for ($i = 1; $i <= 5; $i++) {
                        ...
                        if (isset($image['Uploadimglink'][$imageLinkIndex])) {
                            ...
                            if (!empty($imageLink)) {
                                ...
                                // Use CakePHP's file class to handle file operations
                                $filePath = TMP . 'temp_image_' . uniqid() . '.jpg';
                                file_put_contents($filePath, $fileContent);
    
                                // Add the downloaded image to the zip file
                                $zipFileEntry = "{$image['Uploadimglink']['SKU_CODE']}_image{$i}.jpg";
                                $this->addFileToZip($zipFile, $filePath, $zipFileEntry);
